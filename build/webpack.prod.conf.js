    ...
    new CopyWebpackPlugin([
      {
        ...
        from: path.resolve(__dirname, '../src/views/partial'),
        to: path.join(config.build.assetsRoot, 'views/partial')
      }
    ]),
...
webpackConfig.plugins.push(new HtmlWebpackInjectAssetsPlugin());
